 ...
 * @author tomw
 */
//@WebServlet(name = "PsCloudRemoveSiteServlet", urlPatterns = {"/cloudRemoveSite"})
public class PsCloudRemoveSiteServlet extends HttpServlet {
...
//            out.println("<html>");
//            out.println("<head>");
//            out.println("<title>Servlet PsCloudRemoveSiteServlet</title>");            
//            out.println("</head>");
//            out.println("<body>");
//            out.println("<h1>Servlet PsCloudRemoveSiteServlet at " + request.getContextPath() + "</h1>");
//            out.println("</body>");
//            out.println("</html>");

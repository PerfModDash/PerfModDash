...
/**
 * takes host with given id and adds all primitive services to it the services
 * are created and added to data store. //TODO maybe add returning json objects
 * of created services
 *
 * @author tomw
 */
//@WebServlet(name = "PsHostAddAllPrimitiveServicesServlet", urlPatterns = {"/hostAddAllServices"})
public class PsHostAddAllPrimitiveServicesServlet extends HttpServlet {
...
//            out.println("<html>");
//            out.println("<head>");
//            out.println("<title>Servlet PsHostAddAllPrimitiveServicesServlet</title>");            
//            out.println("</head>");
//            out.println("<body>");
//            out.println("<h1>Servlet PsHostAddAllPrimitiveServicesServlet at " + request.getContextPath() + "</h1>");

...
/**
 * create new site, assign it unique id, fill it with parameters from json
 * object, if available. If name parameter is specified, give the site the
 * requested name Return json object of the new site.
 *
 * @author tomw
 */
//@WebServlet(name = "PsCreateSiteServlet", urlPatterns = {"/createSite"})
public class PsCreateSiteServlet extends HttpServlet {
...
//            out.println("<html>");
//            out.println("<head>");
//            out.println("<title>Servlet PsCreateSiteServlet</title>");            
//            out.println("</head>");
//            out.println("<body>");
//            out.println("<h1>Servlet PsCreateSiteServlet at " + request.getContextPath() + "</h1>");                      
//            
//         
//            out.println("</body>");
//            out.println("</html>");
            ...
            if (request.getParameter("name") != null && !"".equals(request.getParameter("name"))) {
                ...
                site = PsObjectCreator.createNewSite(siteName);
            } else {
                site = PsObjectCreator.createNewSite();
            }

...
/**
 * Add host to a matrix Arguments: matrixId of matrixName - define the matrix
 * hostId or hostName - define the host return JSON representation of matrix
 *
 * @author tomw
 */
//@WebServlet(name = "PsMatrixAddHostServlet", urlPatterns = {"/addHostToMatrix"})
public class PsMatrixAddHostServlet extends HttpServlet {

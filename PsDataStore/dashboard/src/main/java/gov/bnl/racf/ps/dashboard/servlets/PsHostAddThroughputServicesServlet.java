...
/**
 * Get a host with a given Id and add throughput primitive services to it.
 * Return JSON object of this host.
 *
 * @author tomw
 */
//@WebServlet(name = "PsHostAddThroughputServicesServlet", urlPatterns = {"/hostAddThroughputServices"})
public class PsHostAddThroughputServicesServlet extends HttpServlet {
...
//            out.println("<html>");
//            out.println("<head>");
//            out.println("<title>Servlet PsHostAddThroughputServicesServlet</title>");            
//            out.println("</head>");
//            out.println("<body>");
//            out.println("<h1>Servlet PsHostAddThroughputServicesServlet at " + request.getContextPath() + "</h1>");

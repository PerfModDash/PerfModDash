...
/**
 * The action to display the delete host page.
 * Standard behaviors like the get and set methods for HostDeletePageAction object properties are defined here.
 * @author siliu
 */
public class HostDeletePageAction {
   ...
   private Host one_host;
    ...
    public HostDeletePageAction() {
    }
    /**
     * The method to invoke the logical method to query host that to be deleted.

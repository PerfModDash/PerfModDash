 ...
 */
package gov.bnl.racf.ps.dashboard3.domainobjects.initialisation;
...
public class PsServiceTypeFactory {
    ...
    public static ArrayList<String> listOfServiceTypes() {
    ...
    public static ArrayList<String> listOfPrimitiveThroughputServiceTypes() {
        ArrayList<String> serviceTypes = new ArrayList<String>();
        serviceTypes.add(PsServiceType.BWCTL_PORT_4823);
        serviceTypes.add(PsServiceType.BWCTL_PORT_8570);
        serviceTypes.add(PsServiceType.NDT_PORT_3001);
    ...
    public static ArrayList<String> listOfPrimitiveServiceTypes() {
        ArrayList<String> serviceTypes = new ArrayList<String>();
        serviceTypes.add(PsServiceType.BWCTL_PORT_4823);
        serviceTypes.add(PsServiceType.BWCTL_PORT_8570);
        serviceTypes.add(PsServiceType.NDT_PORT_3001);
     ...
     * @return 
     */
    public static ArrayList<String> listOfPrimitiveLatencyServiceTypes() {
        ArrayList<String> serviceTypes = new ArrayList<String>();
        serviceTypes.add(PsServiceType.OWP_861);
        serviceTypes.add(PsServiceType.OWP_8569);
        serviceTypes.add(PsServiceType.PERFSONAR_PSB);
